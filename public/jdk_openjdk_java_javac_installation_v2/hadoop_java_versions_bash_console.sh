...
do 
    case $opt in
        ...
        "- JAVA JDK INSTALLER")
            ...
            read enter
            bash /home/hadoopuser/jdk_openjdk_java_javac_installation/java_javac_jdk_openjdk_installer.sh
        ...
        "- CHECK JAVA INSTALLED VERSIONS")
            ...
            echo "PRESS ENTER TO RUN SCRIPT NOW..."
            read enter
            bash /home/hadoopuser/jdk_openjdk_java_javac_installation/check_java_installed_versions.sh
            ;;
        ...
        "- CHECK SET JAVA HOME PATH")
            ...
            echo "PRESS ENTER TO RUN SCRIPT NOW..."
            read enter
            bash /home/hadoopuser/jdk_openjdk_java_javac_installation/check_set_java_home_path.sh
            ;;
        ...
        "- INSTALL A JAVA VERSION")
            ...
            echo "PRESS ENTER TO RUN SCRIPT NOW..."
            read enter
            bash /home/hadoopuser/jdk_openjdk_java_javac_installation/java_version_install_java_jdk_openjdk.sh
            ;;
        ...
        "- REMOVE A JAVA VERSION")
            ...
            echo "PRESS ENTER TO RUN SCRIPT NOW..."
            read enter
            bash /home/hadoopuser/jdk_openjdk_java_javac_installation/java_version_remove_java_jdk_openjdk.sh
            ;;
	...
	"- SWITCH JAVA VERSION")
	    ...
	    echo "PRESS ENTER TO RUN SCRIPT NOW..."
            read enter
            bash /home/hadoopuser/jdk_openjdk_java_javac_installation/switch_java_jdk_openjdk_version.sh
            ;;
