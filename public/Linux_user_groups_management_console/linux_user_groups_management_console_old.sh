...
#
	...
	"+ Add user to a group")
            ...
            echo "PRESS ENTER TO RUN SCRIPT NOW..."
            read enter
            bash /home/$USER/Linux_user_groups_management_console/add_user_to_group.sh
            ;;
